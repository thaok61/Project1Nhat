...
export default new Vuex.Store({
    state: {
        ...
        orders: [
            {id:0, idBook: 0, nameBook: "Cho tôi xin một vé về tuổi thơ", quantity: 10, date: "2020-08-27", idSV: "20163698" ,isReturnBook: false},
            {id:1, idBook: 1, nameBook: "Bí Mật Tư Duy Triệu Phú", quantity: 11, date: "2020-07-26", idSV: "20163668" ,isReturnBook: true},
            {id:2, idBook: 2, nameBook: "Người Giàu Có Nhất Thành Babylon", quantity: 12, date: "2020-06-27", idSV: "20163638" ,isReturnBook: true},
            {id:3, idBook: 3, nameBook: "Thám Tử Lừng Danh Conan", quantity: 13, date: "2020-04-23", idSV: "20143668" ,isReturnBook: false},
        ]
    },
    getters: {
        ...
        getBookByIdCategory: (state) => (id) => {
            return state.books.filter(book => book.idCategory == id)
        },
        booksCount: (state) => {
